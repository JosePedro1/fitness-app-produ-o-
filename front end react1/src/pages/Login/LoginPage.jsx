      ...
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;-webkit-font-smoothing:antialiased}
        :root{
          ...
          --red:#ef4444;--red-bg:rgba(239,68,68,0.1);--green:#22c55e;
          --radius-sm:8px;
        }
        ...
        .field-hint{font-size:12px;color:var(--text3);text-align:right;margin-top:4px;cursor:pointer;transition:color .2s}
        ...
        <div className="auth-card">
          ...
          <form onSubmit={doLogin}>
            ...
            <div className="field">
              ...
              <Link to="/forgot-password" className="field-hint" style={{ display: 'block', textAlign: 'right', marginTop: 4, color: 'var(--text3)', fontSize: 12, textDecoration: 'none' }}>
                Esqueceu sua senha?
              </Link>
            </div>
